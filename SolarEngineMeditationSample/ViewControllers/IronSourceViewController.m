...
@interface IronSourceViewController ()

@property (nonatomic, strong) IronSourceSampleAdManager *ironSourceManager;
...
@implementation IronSourceViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self setupUI];
    [self setupIronSourceManager];
}

- (void)setupUI {
    self.title = @"IronSource Ads";
...
- (void)setupIronSourceManager {
    self.ironSourceManager = [[IronSourceSampleAdManager alloc] init];
    [self.ironSourceManager initializeSDK];
}
...
- (void)loadInterstitial {
    [LogUtils i:@"Loading IronSource Interstitial ad"];
    [self.ironSourceManager loadInterstitialAd];
}

- (void)showInterstitial {
    [LogUtils i:@"Showing IronSource Interstitial ad"];
    [self.ironSourceManager showInterstitialAdFromViewController:self];
}

- (void)loadRewarded {
    [LogUtils i:@"Loading IronSource Rewarded ad"];
    [self.ironSourceManager loadRewardedAd];
}

- (void)showRewarded {
    [LogUtils i:@"Showing IronSource Rewarded ad"];
    [self.ironSourceManager showRewardedAdFromViewController:self];
}

- (void)loadBanner {
    [LogUtils i:@"Loading IronSource Banner ad"];
    [self.ironSourceManager loadBannerAdFromViewController:self];
    ISBannerView *bannerView = [self.ironSourceManager getBannerView];
