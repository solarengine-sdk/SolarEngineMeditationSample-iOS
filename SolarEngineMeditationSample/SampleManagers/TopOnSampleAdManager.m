...
@interface TopOnSampleAdManager () <ATInterstitialDelegate, ATRewardedVideoDelegate, ATBannerDelegate>
...
@implementation TopOnSampleAdManager

+ (instancetype)shared {
    static TopOnSampleAdManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[TopOnSampleAdManager alloc] init];
    });
    return instance;
}

- (void)initializeSDK {
    [LogUtils i:@"TopOnSampleAdManager.initializeSDK() called"];
    //Enable logging
    ...
    [LogUtils i:@"TopOn SDK initialized successfully"];
}

- (void)loadInterstitialAd {
    NSString *adUnitID = [[TopOnConfig shared] getAdUnitIdForAdType:AdTypeInterstitial];
    [LogUtils i:[NSString stringWithFormat:@"Loading TopOn Interstitial ad with unit ID: %@", adUnitID]];
...
- (void)showInterstitialAdFromViewController:(UIViewController *)viewController {
    ...
    if (![[ATAdManager sharedManager] interstitialReadyForPlacementID:adUnitID]) {
        ...
        [LogUtils w:@"Topon Interstitial ad not ready yet"];
    }
}

- (void)loadRewardedAd {
    NSString *adUnitID = [[TopOnConfig shared] getAdUnitIdForAdType:AdTypeRewarded];
    [LogUtils i:[NSString stringWithFormat:@"Loading TopOn Rewarded ad with unit ID: %@", adUnitID]];
    NSMutableDictionary * loadConfigDict = [NSMutableDictionary dictionary];
...
- (void)showRewardedAdFromViewController:(UIViewController *)viewController {
    ...
    if (![[ATAdManager sharedManager] rewardedVideoReadyForPlacementID:adUnitID]) {
        ...
        [LogUtils w:@"Topon Rewarded ad not ready yet"];
    }
}

- (void)loadBannerAd {
    NSString *adUnitID = [[TopOnConfig shared] getAdUnitIdForAdType:AdTypeBanner];
...
- (void)interstitialDidShowForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Interstitial ad showed"];
}

- (void)interstitialDidFailToShowForPlacementID:(NSString *)placementID error:(NSError *)error extra:(NSDictionary *)extra {
    [LogUtils e:[NSString stringWithFormat:@"TopOn Interstitial ad failed to show: %@", error.localizedDescription]];
}

- (void)interstitialDidClickForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Interstitial ad clicked"];
}

- (void)interstitialDidCloseForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Interstitial ad closed"];
}

- (void)interstitialDidStartPlayingVideoForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Interstitial video started"];
}

- (void)interstitialDidEndPlayingVideoForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Interstitial video ended"];
}

- (void)interstitialDidFailToPlayVideoForPlacementID:(NSString *)placementID error:(NSError *)error extra:(NSDictionary *)extra {
    [LogUtils e:[NSString stringWithFormat:@"TopOn Interstitial video failed to play: %@", error.localizedDescription]];
}
...
- (void)didRevenueForPlacementID:(NSString *)placementID
    ...
    //Just for example
    if (@"Interstitial") {
        [TopOnAdWrapper trackInterstitialAdRevenue:placementID extra:extra];
    }else if (@"RewardedVideo"){
        [TopOnAdWrapper trackRewardedAdRevenue:placementID extra:extra];
    }
}
...
- (void)rewardedVideoDidShowForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Rewarded ad showed"];
}

- (void)rewardedVideoDidFailToShowForPlacementID:(NSString *)placementID error:(NSError *)error extra:(NSDictionary *)extra {
    [LogUtils e:[NSString stringWithFormat:@"TopOn Rewarded ad failed to show: %@", error.localizedDescription]];
}

- (void)rewardedVideoDidClickForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Rewarded ad clicked"];
}

- (void)rewardedVideoDidCloseForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Rewarded ad closed"];
}

- (void)rewardedVideoDidStartPlayingForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Rewarded video started"];
}

- (void)rewardedVideoDidEndPlayingForPlacementID:(NSString *)placementID extra:(NSDictionary *)extra {
    [LogUtils i:@"TopOn Rewarded video ended"];
}
...
- (void)bannerView:(ATBannerView *)bannerView didFailToShowAdWithPlacementID:(NSString *)placementID error:(NSError *)error extra:(NSDictionary *)extra {
    [LogUtils e:[NSString stringWithFormat:@"TopOn Banner ad failed to show: %@", error.localizedDescription]];
}
